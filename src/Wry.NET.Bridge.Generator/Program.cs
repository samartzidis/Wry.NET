...
///
/// Usage: Wry.NET.Bridge.Generator &lt;assembly-path&gt; &lt;output-dir&gt;
/// </summary>
class Program
{
    internal static int Main(string[] args)
    {
        ...
        try
        {
            ...
            // Discover from main assembly and project-referenced assemblies (e.g. Wry.NET, Wry.NET.Bridge)
            ...
            {
                Console.WriteLine($"[{CodeEmitter.ToolName}] No [BridgeService] or [BridgeEvent] types found.");
                return 0;
            }
            ...
            Console.WriteLine($"[{CodeEmitter.ToolName}] Done. Generated bindings for {services.Count} service(s), {events.Count} event(s), {modelTypes.Count} model(s).");
            return 0;
        }
        catch (Exception ex)
        {
    ...
    /// libraries like Wry.NET.Bridge as well as the app).
    /// </summary>
